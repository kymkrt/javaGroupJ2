...
<head>
  <meta charset="UTF-8">
  <title>adminOfAllMessageControl.jsp</title>
...
<p><br /></p>
<div class="container">
  <h2 class="text-center mb-3">모 든 회 원 메 세 지 리 스 트(관리자)</h2>
  <div>
  	<a href="AdminMessageControl.msg" class="btn btn-info">내 메세지 보기</a>
  </div>
  <!--메세지 목록들-->
  <c:if test="">
