...
<head>
  <meta charset="UTF-8">
  <title>marketingDetailView.jsp</title>
  <jsp:include page="/include/bs4.jsp" />
	...
	<script type="text/javascript">
		...
		function deleteCheck() {
			...
			if(ans) location.href = "MarketingDelete.board?idx=${vo.idx}";
		}
	</script>
</head>
<body>
...
<div class="container">
  ...
  <div class="row text-center">
  	<c:if test="${sMid == vo.mid || sLevel == 0}">
  		...
  		<div class="col"><button type="button" onclick="location.href='MarketingList.board'" class="btn btn-primary">돌아가기</button> </div>
  </div>
</div>
<p><br /></p>
