...
create table freeBoard(
	...
	part varchar(10) NOT NULL DEFAULT 'all',
...
create table freeReply (
	idx int not null auto_increment, /*자유게시판 댓글의 고유번호*/
	...
	primary key(idx),
	foreign key(replyIdx) references freeBoard(idx) on update cascade ON DELETE CASCADE,
	foreign key(parentReplyIdx) references freeReply(idx) on update cascade ON DELETE CASCADE
);