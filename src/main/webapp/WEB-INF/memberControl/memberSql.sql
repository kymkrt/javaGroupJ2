...
create table member (
	...
	telMain int not null,  /*메인전화번호 : 010-1234-5678 */
	telSub int,  /*서브전화번호 : 010-1234-5678 */
	...
	/*사업자일시 추가 부분*/
	fax int,  /*팩스번호 : 010-1234-5678 */
	companyName varchar(100), /*회사명 사업자 일때만*/
	BSNum int not null default '0', /*사업자 번호 없으면 0*/
	/*관리자 처리 부분*/
