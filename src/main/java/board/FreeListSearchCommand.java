...
public class FreeListSearchCommand implements BoardInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totRecCnt = dao.getSearchTotRecCnt(partkey,keyword, "freeboard");
		...
		vos = dao.getSearchFreeBoardList(partkey, keyword, startIndexNo, pageSize);
